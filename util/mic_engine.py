...
class MicEngine:
    ...
    def init_stream(self, sampling_rate=16000, frame_size=4000):
        ...
        self.stream = self.pyaudio_engine.open(format=paInt16, channels=1, rate=self.sampling_rate, input=True,
                                               input_device_index=-1, frames_per_buffer=self.frame_size)
